if (window,location.pathname === "/drivers") {
    ...
    function getURL() {
        if (window.location.hostname === "localhost") {
            return new URL("http://localhost:3000/drivers/dashboard");
        } else {
            return new URL("https://timesheet-uk.herokuapp.com/drivers/dashboard");
        }
    }
    ...
    function displayAverageHourlyRate(totalTimeFloat, totalValue) {
        const averageHourlyRate = parseFloat((totalValue / totalTimeFloat).toFixed(2));
