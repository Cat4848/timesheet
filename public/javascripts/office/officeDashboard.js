...
if (window.location.pathname === "/office") {
    ...
    function getURL(path) {
        if (path !== "") {
            if (window.location.hostname === "localhost") {
                return new URL(`http://localhost:3000/office/dashboard/${path}`);
            } else {
                return new URL(`https://timesheet-uk.herokuapp.com/office/dashboard/${path}`);
            }
        } else {
            if (window.location.hostname === "localhost") {
                return new URL("http://localhost:3000/office/dashboard");
            } else {
                return new URL("https://timesheet-uk.herokuapp.com/office/dashboard");
            }
        }
    }
    ...
    function compare1DisplayFinancialData(data) {
        ...
        const totalDriversHours = document.querySelector("#compare1-total-drivers-hours");
    ...
    function compare2DisplayFinancialData(data) {
        ...
        const totalDriversHours = document.querySelector("#compare2-total-drivers-hours");
