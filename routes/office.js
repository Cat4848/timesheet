...
router.post("/drivers", async (req, res) => {
    ...
    console.log("drivers route -> create new driver -> driver", driver);
    try {
...
router.get("/drivers/:id", async (req, res) => {
    ...
    console.log("view one particular driver based on id");
    let driver;
...
router.put("/drivers/:id", async (req, res) => {
    ...
    console.log("office -> drivers put route");
    const driverId = req.params.id;
    let driver;
    try {
        driver = await Driver.findById(driverId);
...
router.delete("/drivers/:id", async (req, res) => {
    ...
    console.log("delete driver route");
    const driverId = req.params.id;
    let driver;
    try {
        driver = await Driver.findById(driverId);
...
router.get("/workplaces/:id", async (req, res) => {
    ...
    console.log("view a particular workplace");
...
router.get("/workplaces/:id/edit", async (req, res) => {
    ...
    console.log("Edit a particular workplace. Serving the edit page");
    const workplaceId = req.params.id;
    try {
        const workplace = await Workplace.findById(workplaceId);
...
router.put("/workplaces/:id", async (req, res) => {
    ...
    console.log("put route. edit a workplace in MongoDB");
    const workplaceId = req.params.id;
    let workplace;
    try {
...
router.delete("/workplaces/:id", async (req, res) => {
    ...
    console.log("delete a workplace route");
    const workplaceId = req.params.id;
    let workplace;
    try {
        workplace = await Workplace.findById(workplaceId);
...
router.get("/new", (req, res) => {
    ...
    console.log("new office admin form");
...
router.post("/", async (req, res) => {
    ...
    console.log("beginning post new office admin route");
    ...
    if (req.body.name != "" && req.body.email != "" && req.body.password != "") {
        ...
        console.log("post new office admin", officeAdmin);
    } else {
        officeAdmin.password = req.body.password;
        res.render("office/officeAdmin/new", {
            officeAdmin: officeAdmin,
...
router.get("/:id/edit", async (req, res) => {
    ...
    console.log("render edit office admin form");
...
router.put("/:id", async (req, res) => {
    ...
    console.log("edit office admin in Mongo DB");
    const officeAdminId = req.params.id;
...
router.delete("/:id", async (req, res) => {
    ...
    console.log("office admin delete route");
    const officeAdminId = req.params.id;
    try {
...
router.get("/:id", async (req, res) => {
    ...
    console.log("view a particular office admin route");
    const officeAdminId = req.params.id; 
    try {
        const officeAdmin = await OfficeAdmin.findById(officeAdminId);
