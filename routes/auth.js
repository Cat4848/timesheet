...
async function checkRefreshTokenExists(user) {
    ...
    if (!refreshTokens.length) {
        ...
        if (!unusedRefreshToken.length) {
            ...
            console.log("checkRefreshTokenExists function -> last else statement -> refreshToken", refreshToken);
            return refreshToken;
        }
    }
}
...
async function addNewRefreshTokenToDB(user, refreshToken) {
    ...
    try {
        ...
        console.log("Authentication file: Error adding a new Refresh Token to Mongo DB", error);
    ...
    async (req, res) => {
        ...
        (async () => {
            ...
            if (refreshTokenCheck instanceof Error) {
                ...
                jwt.verify(refreshTokenCheck, process.env.REFRESH_TOKEN_SECRET, (error, user) => {
                    if (error) {
